...
<?php
	...
	$albumid = !empty($_GET['id']) ? (int)$_GET['id'] : 1;
	$album = Album::find_by_id($albumid);
	$albumname = $album->album_name;
	
	// Instead of finding all records, just find the records 
	// for this page
	$sql = "SELECT * FROM photographs WHERE user_id={$userid} AND album_id={$albumid} ";
	$sql .= "LIMIT {$per_page} ";
...
<div id="pageheader">
<h2><?php echo $fullname; ?>'s Photos</h2>
<h2>Photo Album: <?php echo $albumname; ?></h2>
</div>
<?php
...
<a href="photo_upload.php?albumid=<?php echo $albumid; ?>">Add a Photo To This album</a>
