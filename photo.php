...
$photo_user = User::find_by_id($photo->user_id);    
    
// new photo comment insert code
...
<div id="photoblock">
<div id="photo" >
  <img src="<?php  echo $photo->image_path(); ?>"  class="photo" />
  <div id="caption">
    <p><?php  echo $photo->caption; ?></p>
  </div>
  <p>Posted by: <a href="profile.php?id=<?php echo $photo_user->id; ?>"><?php  echo $photo_user->full_name(); ?></a></p>
<!-- end#photo --></div>
<br class="clearfloat" />
<!-- end#photoblock --></div>
<br class="clearfloat" />
